...
public:
	...
	WebFile GenerateTitleXml(const std::wstring& boxId, const std::wstring& documentTypeNamedId, const std::wstring& documentFunction, const std::wstring& documentVersion, int titleIndex, const Bytes_t& userContractData, const std::wstring& editingSettingId = std::wstring(), bool disableValidation = false, const std::wstring& letterId = std::wstring(), const std::wstring& documentId = std::wstring());
