...
RoamingNotification::RoamingNotification()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Diadoc.Api.Proto.RoamingNotification)
}
...
RoamingNotification::RoamingNotification(const RoamingNotification& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Diadoc.Api.Proto.RoamingNotification)
}
...
RoamingNotification::~RoamingNotification() {
  // @@protoc_insertion_point(destructor:Diadoc.Api.Proto.RoamingNotification)
  SharedDtor();
}
...
const RoamingNotification& RoamingNotification::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_RoamingNotification_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Diadoc.Api.Proto.RoamingNotification)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Diadoc.Api.Proto.RoamingNotification)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Diadoc.Api.Proto.RoamingNotification)
  return false;
#undef DO_
}
...
void RoamingNotification::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Diadoc.Api.Proto.RoamingNotification)
  // required bool Success = 1;
  if (has_success()) {
  ...
  // @@protoc_insertion_point(serialize_end:Diadoc.Api.Proto.RoamingNotification)
}

::google::protobuf::uint8* RoamingNotification::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Diadoc.Api.Proto.RoamingNotification)
  // required bool Success = 1;
  if (has_success()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Diadoc.Api.Proto.RoamingNotification)
  return target;
}
