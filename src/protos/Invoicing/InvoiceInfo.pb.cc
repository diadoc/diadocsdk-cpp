...
const InvoiceInfo& InvoiceInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Invoicing_2fInvoiceInfo_2eproto();  return *default_instance_;
}
...
bool InvoiceInfo::IsInitialized() const {
  ...
  for (int i = 0; i < paymentdocuments_size(); i++) {
    if (!this->paymentdocuments(i).IsInitialized()) return false;
  }
  for (int i = 0; i < items_size(); i++) {
    if (!this->items(i).IsInitialized()) return false;
  }
  for (int i = 0; i < additionalinfos_size(); i++) {
    if (!this->additionalinfos(i).IsInitialized()) return false;
  }
  return true;
}
      ...
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_CountriesOfOrigin:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->countriesoforigin(0).data(), this->countriesoforigin(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_CustomsDeclarationNumbers:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->customsdeclarationnumbers(0).data(), this->customsdeclarationnumbers(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
bool InvoiceItem::IsInitialized() const {
  ...
  for (int i = 0; i < customsdeclarations_size(); i++) {
    if (!this->customsdeclarations(i).IsInitialized()) return false;
  }
  for (int i = 0; i < additionalinfos_size(); i++) {
    if (!this->additionalinfos(i).IsInitialized()) return false;
  }
