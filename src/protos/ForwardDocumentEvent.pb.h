...
inline const ::Diadoc::Api::Proto::Timestamp& ForwardDocumentEvent::timestamp() const {
  // @@protoc_insertion_point(field_get:Diadoc.Api.Proto.ForwardDocumentEvent.Timestamp)
...
inline ::Diadoc::Api::Proto::Timestamp* ForwardDocumentEvent::mutable_timestamp() {
  ...
  // @@protoc_insertion_point(field_mutable:Diadoc.Api.Proto.ForwardDocumentEvent.Timestamp)
  return timestamp_;
}
...
inline void ForwardDocumentEvent::set_allocated_timestamp(::Diadoc::Api::Proto::Timestamp* timestamp) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Diadoc.Api.Proto.ForwardDocumentEvent.Timestamp)
}
...
inline const ::std::string& ForwardDocumentEvent::toboxid() const {
  // @@protoc_insertion_point(field_get:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
  return *toboxid_;
}
inline void ForwardDocumentEvent::set_toboxid(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
}
inline void ForwardDocumentEvent::set_toboxid(const char* value) {
  ...
  toboxid_->assign(value);
  // @@protoc_insertion_point(field_set_char:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
}
inline void ForwardDocumentEvent::set_toboxid(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
}
inline ::std::string* ForwardDocumentEvent::mutable_toboxid() {
  ...
  // @@protoc_insertion_point(field_mutable:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
  return toboxid_;
}
...
inline void ForwardDocumentEvent::set_allocated_toboxid(::std::string* toboxid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Diadoc.Api.Proto.ForwardDocumentEvent.ToBoxId)
}
