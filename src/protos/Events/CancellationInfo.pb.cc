...
void protobuf_AssignDesc_Events_2fCancellationInfo_2eproto() {
  protobuf_AddDesc_Events_2fCancellationInfo_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "Events/CancellationInfo.proto");
  GOOGLE_CHECK(file != NULL);
  CancellationInfo_descriptor_ = file->message_type(0);
  static const int CancellationInfo_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CancellationInfo, author_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_Events_2fCancellationInfo_2eproto);
}
...
void protobuf_AddDesc_Events_2fCancellationInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "Author\030\001 \002(\t", 92);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "Events/CancellationInfo.proto", &protobuf_RegisterTypes);
  CancellationInfo::default_instance_ = new CancellationInfo();
  CancellationInfo::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_Events_2fCancellationInfo_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_Events_2fCancellationInfo_2eproto {
  StaticDescriptorInitializer_Events_2fCancellationInfo_2eproto() {
    protobuf_AddDesc_Events_2fCancellationInfo_2eproto();
  }
} static_descriptor_initializer_Events_2fCancellationInfo_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int CancellationInfo::kAuthorFieldNumber;
#endif  // !_MSC_VER

CancellationInfo::CancellationInfo()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Diadoc.Api.Proto.Events.CancellationInfo)
}
...
CancellationInfo::CancellationInfo(const CancellationInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Diadoc.Api.Proto.Events.CancellationInfo)
}
...
CancellationInfo::~CancellationInfo() {
  // @@protoc_insertion_point(destructor:Diadoc.Api.Proto.Events.CancellationInfo)
  SharedDtor();
}
...
const CancellationInfo& CancellationInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Events_2fCancellationInfo_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Diadoc.Api.Proto.Events.CancellationInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Diadoc.Api.Proto.Events.CancellationInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Diadoc.Api.Proto.Events.CancellationInfo)
  return false;
#undef DO_
}
...
void CancellationInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Diadoc.Api.Proto.Events.CancellationInfo)
  // required string Author = 1;
  if (has_author()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->author().data(), this->author().length(),
  ...
  // @@protoc_insertion_point(serialize_end:Diadoc.Api.Proto.Events.CancellationInfo)
}

::google::protobuf::uint8* CancellationInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Diadoc.Api.Proto.Events.CancellationInfo)
  // required string Author = 1;
  if (has_author()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->author().data(), this->author().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Diadoc.Api.Proto.Events.CancellationInfo)
  return target;
}
