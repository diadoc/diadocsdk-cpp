...
ResolutionRequestDenialInfo::ResolutionRequestDenialInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
}
...
ResolutionRequestDenialInfo::ResolutionRequestDenialInfo(const ResolutionRequestDenialInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
}
...
ResolutionRequestDenialInfo::~ResolutionRequestDenialInfo() {
  // @@protoc_insertion_point(destructor:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  return false;
#undef DO_
}
...
void ResolutionRequestDenialInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  // required string Author = 1;
  if (has_author()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->author().data(), this->author().length(),
  ...
  // @@protoc_insertion_point(serialize_end:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
}

::google::protobuf::uint8* ResolutionRequestDenialInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  // required string Author = 1;
  if (has_author()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->author().data(), this->author().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Diadoc.Api.Proto.Events.ResolutionRequestDenialInfo)
  return target;
}
