...
Content::Content()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Diadoc.Api.Proto.Content)
}
...
Content::Content(const Content& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Diadoc.Api.Proto.Content)
}
...
Content::~Content() {
  // @@protoc_insertion_point(destructor:Diadoc.Api.Proto.Content)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Diadoc.Api.Proto.Content)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Diadoc.Api.Proto.Content)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Diadoc.Api.Proto.Content)
  return false;
#undef DO_
}
...
void Content::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Diadoc.Api.Proto.Content)
  // required sfixed32 Size = 1;
  if (has_size()) {
  ...
  // @@protoc_insertion_point(serialize_end:Diadoc.Api.Proto.Content)
}

::google::protobuf::uint8* Content::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Diadoc.Api.Proto.Content)
  // required sfixed32 Size = 1;
  if (has_size()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Diadoc.Api.Proto.Content)
  return target;
}
