...
void protobuf_AssignDesc_AcquireCounteragent_2eproto() {
  ...
  static const int InvitationDocument_offsets_[3] = {
...
void protobuf_AddDesc_AcquireCounteragent_2eproto() {
  ...
  ::Diadoc::Api::Proto::Events::protobuf_AddDesc_Events_2fDiadocMessage_2ePostApi_2eproto();
...
const AcquireCounteragentRequest& AcquireCounteragentRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_AcquireCounteragent_2eproto();  return *default_instance_;
}
